...
let apiUrl = 'https://api.github.com/repos/TonyJiangWJ/Unify-Sign/releases/latest'
...
// 设置不需要解压覆盖的文件
// 请勿移除'lib/download.dex' 否则引起报错
downloader.setUnzipSkipFiles(['.gitignore', 'lib/download.dex'])
// 设置不需要备份的文件
...
if (summary === null) {
  loadingDialog.setContent('无法获取release版本信息，请多试几次')
  sleep(1000)
